                ...
                <div class="container-fluid">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-6" style="text-align:end">
                            <a href={{ url('/en/admin/dashboard/admins/addAdmin') }} class="btn btn-primary rounded">
                            ...
                            <div class="col-sm-12 col-md-6 mb-2">
                                <div class="card custom-card h-100" style="background: white">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            <a href={{ url('/en/admin/dashboard/admins/admin/'.$admin['id']) }} class="btn btn-success">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <form action="{{ url('/en/admin/dashboard/admins/delete/'.$admin['id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this admin?');">
                                                @csrf
                                                @method('DELETE')
