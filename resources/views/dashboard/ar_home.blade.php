                ...
                <div class="container-fluid">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-6" style="text-align:end">
                            <a href={{ url('/en/admin/dashboard/addteacher/ar') }} class="btn btn-primary rounded">
                        ...
                        @foreach ($arTeachers as $teacher)
                            <div class="col-sm-12 col-md-6 col-lg-3 mb-2">
                                <div class="card custom-card h-100" style="background: white"
                                    data-id="{{ $teacher['id'] }}">
                                    <div class="card-body">
                                        <img src={{ asset('storage/' . $teacher['teacher_image']) }}
                                            class="me-2 img-fluid" alt={{ $teacher['teacher_name'] }}
                                        ...
                                        <div class="d-flex">
                                            <a href={{ url('/en/admin/dashboard/updateteacher/' . $teacher['id'] . '/' . $teacher['lang']) }}
                                                class="btn btn-success ms-2">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <form action="{{ url('/en/admin/dashboard/ar/' . $teacher['id']) }}"
                                                method="POST"
