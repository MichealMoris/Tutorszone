                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            ...
                            @endif
                            <form action={{ url('/en/admin/dashboard/admins/storeAdmin') }} method="POST">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="adminPermission" name="adminPermission">
                                        ...
                                        <option value="admin" {{ old('adminPermission') == 'admin' ? 'selected' : '' }}>
                                            Admin</option>
                                        <option value="superadmin" {{ old('adminPermission') == 'superadmin' ? 'selected' : '' }}>
                                            Superadmin</option>
                                    </select>
                                </div>
