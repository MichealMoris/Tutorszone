                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            ...
                            @endif
                            <form action={{ url('/en/admin/dashboard/addteacher/'.$ln) }} method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="teacherImage" class="form-label">Teacher Image</label>
                                    <div class="mb-3">
                                        <img id="preview" class="preview-img d-none" alt="Teacher Image Preview"
                                            style={{'padding:5px;width:10rem;height:10rem;object-fit:cover;border-radius:50%;border:2px;border-style:solid;color:'.old('teacherColor')}}>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="teacherCountry" name="teacherCountry">
                                        ...
                                        <option value="uae" {{ old('teacherCountry') == 'uae' ? 'selected' : '' }}>
                                            United Arab
                                            Emirates</option>
                                        <option value="sa" {{ old('teacherCountry') == 'sa' ? 'selected' : '' }}>
                                            Saudi Arabia</option>
                                        <option value="both" {{ old('teacherCountry') == 'both' ? 'selected' : '' }}>
                                            Both</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="teacherDescription" class="form-label">Teacher Description</label>
                                    <textarea class="form-control" id="teacherDescription" name="teacherDescription" rows="3">{{ old('teacherDescription') }}</textarea>
                                </div>
                                <div class="mb-3">
