                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link align-middle px-0 text-white text-decoration-none">
                                <i class="fs-4 bi-person-workspace"></i> <span class="ms-1 d-none d-sm-inline">Teachers (en)</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href={{ url('/en/admin/dashboard/ar') }} class="nav-link align-middle px-0 text-white text-decoration-none">
                                <i class="fs-4 bi-person-workspace"></i> <span class="ms-1 d-none d-sm-inline">Teachers (ar)</span>
                            </a>
                        </li>
                        <li>
                            <a href={{ url('/en/admin/dashboard/contact') }} class="nav-link px-0 align-middle text-white text-decoration-none">
                                <i class="fs-4 bi-chat-square-text-fill"></i> <span
                                    class="ms-1 d-none d-sm-inline">Contact Number</span></a>
                        </li>
                        <li>
                            <a href={{ url('/en/admin/dashboard/trash') }} class="nav-link px-0 align-middle text-white text-decoration-none">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-6" style="text-align:end">
                            <a href={{url('/en/admin/dashboard/addteacher/en')}} class="btn btn-primary rounded">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-3 mb-2">
                                <div class="card custom-card h-100" style="background: white"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            <a href={{ url('/en/admin/dashboard/updateteacher/'.$teacher['id'].'/'.$teacher['lang']) }} class="btn btn-success">
                                                <i class="bi bi-pencil-square"></i>
                                            </a>
                                            <form action="{{ url('/en/admin/dashboard/'.$teacher['id']) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this teacher?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger ms-2"><i class="bi bi-trash3"></i></button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
